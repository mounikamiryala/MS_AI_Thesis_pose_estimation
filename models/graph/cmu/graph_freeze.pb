...
<head>
    ...
    <meta name="google-translate-customization" content="5587c1b0a958bf07-62a8e309de686e87-gc92f61279a2c8524-11"/>
        ...
        <meta property="og:url" content="https://www.mediafire.com/file/1pyjsjl0p93x27c/graph_freeze.pb/file"/>
        <meta property="og:title" content="graph_freeze"/>
        ...
        <meta name="twitter:url" content="https://www.mediafire.com/file/1pyjsjl0p93x27c/graph_freeze.pb/file"/>
        <meta name="twitter:title" content="graph_freeze"/>
        ...
        <meta itemprop="name" content="graph_freeze"/>
  ...
  googlefc.callbackQueue.push({
                        ...
                        try {
                            ...
                            if (slot) {
                                slot.addService(googletag.pubads())
                                    ...
                                    .setTargeting('buildnumber', '121886')
    ...
    <script>
        try {
            ...
            gtag("js", new Date());
            gtag("config", "UA-829541-1", {"dimension1":"unregistered","dimension7":"legacy","dimension3":"other","dimension4":"34","dimension5":"pb","dimension8":"\/20\/50\/100\/"});
        } catch(e) {}
    </script>
...
<main role="main" class="mf-dlr page ads-alternate">
    ...
    <textarea id="copy" style="position:absolute;left:-9999px;opacity:0" aria-hidden="true" tabindex="-1">https://www.mediafire.com/file/1pyjsjl0p93x27c/graph_freeze.pb/file</textarea>
    <div class="content">
        <style type="text/css">
    .header {
        position: absolute;
...
<div class="dl-btn-cont">
    ...
    <div class="dl-btn-labelWrap">
                ...
                <div class="dl-btn-label"
                    title="graph_freeze.pb">
                    graph_freeze                </div>
            </div>
                        <div class="dl-utility-nav">
            <ul>
                <li>
                    <a href="https://www.mediafire.com/file/1pyjsjl0p93x27c/graph_freeze.pb/file"
                        target="_blank"
                        rel="noopener"
                        id="shareButton"
    ...
    >
        <input type="hidden"
               name="security"
               value="1661086444.991c476854ddb55a3cd5e36ff68568b5dbcf90bf617535665c0bdb5b770d70da"
        >
    ...
    <a class="preparing" href="#"><span>Preparing your download...</span></a>
           ...
           href="http://download1073.mediafire.com/7assefcsxxtg/1pyjsjl0p93x27c/graph_freeze.pb"           id="downloadButton">
                Download (199.62MB)
        </a>
        <a class="starting" href="#"><span>Your download is starting...</span></a>
    <a class="retry" href="http://www.mediafire.com/download_repair.php?qkey=1pyjsjl0p93x27c&amp;dkey=7assefcsxxt&amp;template=34&amp;origin=click_button">
    ...
    <script type="text/javascript">
     (function() {
        ...
        <a href="/customer_diagnosis/questionnaire.php?url=https%3A%2F%2Fwww.mediafire.com%2Ffile%2F1pyjsjl0p93x27c%2Fgraph_freeze.pb%2Ffile" class="download_test_link">
            Download Diagnostic Tool
                ...
                <li>
                    <a href="https://facebook.com/share.php?u=https://www.mediafire.com/file/1pyjsjl0p93x27c/graph_freeze.pb/file"
    ...
    document.addEventListener("DOMContentLoaded", sticky.init.bind(sticky));
            ...
            >
                ...
                <div class="intro icon pb other application_octet-stream">
                    <div class="filename">graph_freeze.pb</div>
                    <div class="filetype"><span>Files</span><span> (.PB)<span></span></span></div>
                </div>
                <ul class="details">
                    <li>File size: <span>199.62MB</span></li>
                    <li>Uploaded: <span>2018-05-14 10:17:13</span></li>
                </ul>
    ...
    <div class="DLExtraInfo">
        ...
        <div class="DLExtraInfo-uploadLocation DLExtraInfo-column">
            ...
            <!-- <div class="DLExtraInfo-sectionHeading">This file&#8217;s upload location</div> -->
                ...
                <p>This file was uploaded from Korea, Republic of on May 14, 2018 at 10:17 AM</p>
            </div>
        </div>
    ...
    <div id="share" class="lightbox" role="dialog" tabindex="-1">
        <figure>
            ...
            <figcaption>
                <iframe
                    id="share-iframe"
                    data-src="http://www.mediafire.com/widgets/share.php?web=1&amp;dlr=1&amp;files=1pyjsjl0p93x27c"
                    allowtransparency="true"
                    style="display:none">
                    <p id="share-desc">
    ...
    <div id="subFooterWrap">
        <div id="subFooter" class="u-wrap">
            <ul class="subFooterLinks">
                <li id="copyrightInfo">&copy;2022 MediaFire<span> Build 121886</span></li>
...
(function() {
  // Options
  var optFileKey = "1pyjsjl0p93x27c";
  var optFileName = "graph_freeze.pb";
  var optFileURL = "https://www.mediafire.com/file/1pyjsjl0p93x27c/graph_freeze.pb/file";
  var optLoggedIn = "false" === "true";
  var optReportTurboDL = "false" === "true";
  var optSecurityToken = "1661086444.991c476854ddb55a3cd5e36ff68568b5dbcf90bf617535665c0bdb5b770d70da";
